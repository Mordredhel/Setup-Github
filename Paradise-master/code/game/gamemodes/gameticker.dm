...
/datum/controller/gameticker/proc/pregame()
	...
	'sound/music/Cuil_Theory.ogg',\
	'sound/music/eRa_-_Enae_Volare_Mezzo.ogg',\
	'sound/music/Heather_Small_-_Proud_[Peter_Presta_QAF_Mix_.ogg',\
	'sound/music/Katie_Melua_-_A_Happy_Place_LYRICS_ON_SCREEN.ogg',\
	'sound/music/Nine_Inch_Nails_-_Right_where_it_belongs.ogg',\
	'sound/music/techno.ogg',\
	'sound/music/The_Forest-_Original_Game_Soundtrack_-_Credits.ogg',\
	'sound/music/The_Forest-_Original_Game_Soundtrack_-_Theme.ogg',\
	'sound/music/Tron_Legacy_-_Trailer_Opening_[Daft_Punk_.ogg') //Ground Control to Major Tom, this song is cool, what's going on?
	do
