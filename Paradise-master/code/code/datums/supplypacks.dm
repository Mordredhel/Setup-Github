...
//Eternia for Chameleon Kit
/datum/supply_packs/chameleon_kit
	name = "Chameleon Kit"
	contains = list(/obj/item/clothing/under/chameleon)
	containertype = 	/obj/item/weapon/storage/box/
	containername = "box"

//Eternia for Pistol+Silencer
/datum/supply_packs/pistol_silencer_ammo_kit
	name = "Pistol, Silencer, and Ammo Kit"
	contains = list(/obj/item/weapon/gun/projectile/silenced,
